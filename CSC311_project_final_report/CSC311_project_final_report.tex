...
\begin{itemize}
    ...
    \item Fully completed the entire Part B of the project and Zixuan Zeng refined Part B by providing improvements to the ensemble model and the ALS method.
