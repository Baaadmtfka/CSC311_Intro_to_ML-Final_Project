...
\author{Group Members: \\ Zixuan Zeng 1008533419 \\ Hao Liu 1003880366 \\ Howard He 1007158246}

\begin{document}

\maketitle

Note: Contributions are at the end of this report.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Item-based KNN:\newline
        The validation accuracy starts at approximately 0.61 for k=1 and steadily increases as k increases.
    ...
    To validate the hybrid KNN model's performance, we designed experiments with different k values and weight combinations ($\alpha$):
    \begin{itemize}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        The hybrid KNN model's computational complexity increases with the number of neighbors k and the size of the dataset. Performing KNN imputation twice (once for users and once for items) adds to the computational load.
        \item Memory Usage:\newline
...
\end{center}
Note: The following page contains Contributions.
...
\begin{itemize}
    ...
    \item Latex project final report.
\end{itemize}
\subsection*{Hao Liu 1003880366}
\begin{itemize}
    \item Independently completed Part A to get familiar with the project.
    \item Refined my Part A based on these discussions and finalized and adopted the refined version as our group's stable solution for Part A.
    \item Fully completed the entire Part B of the project (Hybrid KNN model) and Zixuan Zeng refined Part B by providing improvements to the ensemble model and the ALS method.
    \item Contributed to writing the complete LaTeX final report for Part B.
\end{itemize}
\subsection*{Howard He 1007158246}
\begin{itemize}
    \item Independently completed Part A and did a proof read on part A for any inconsistency.
\end{itemize}
